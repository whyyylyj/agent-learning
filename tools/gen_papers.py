...
("p12", "kimi-k2", "Kimi K2: Open Agentic Intelligence",
 ...
 ["架构：1T 总参 MoE、32B 激活，DeepSeek 式 MLA+MoE 的高效推理。",
 ...
 ["发布时 τ²-bench 等 agent 工具调用基准居开源模型首位、对标闭源前沿；开源权重 + 极低 API 价格，被大量 agent 创业团队直接采用。",
...
("p13", "glm-4-5", "GLM-4.5: Agentic, Reasoning, Coding (ARC)",
 ...
 ["发布时以 355B-A32B 在 12 项 agent 基准平均分居全球前列、开源第一梯队；MIT 协议全开源，国内私有化部署热门选择。"],
